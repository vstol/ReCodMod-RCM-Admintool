...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   $result = $db3->query("SELECT * FROM x_db_play_stats WHERE s_kills>=$limm ORDER BY ($etopx+0) DESC LIMIT 10000");
...
usleep(5000);
  $result = $db2->query("SELECT * FROM `bans` ORDER BY (id+0) DESC LIMIT 10000");
$ik = 0;
   foreach($result as $row)
    {
