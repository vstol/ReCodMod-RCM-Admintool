...
touch($cpath.'ReCodMod/x_update/update.log');
 ...
 try
  ...
  try
  {
    ...
    $db4->exec("CREATE TABLE x_db_players (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, x_db_name varchar(250), x_db_ip int(40), x_db_ping varchar(50), x_db_guid varchar(50), x_db_conn varchar(10), x_db_date varchar(100), x_db_warn varchar(10), x_date_reg varchar(100))"); 

	$db4->exec("CREATE TABLE x_db_play_stats (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, s_player varchar(100), s_place int(10), s_kills int(10), s_deaths int(10), s_grenade int(10), s_skill int(10), s_ratio int(10), s_heads int(10), s_time int(10), s_lasttime varchar(50), s_city varchar(40), s_clear varchar(60), s_guid varchar(60), s_geo varchar(10), s_suicids varchar(10), s_fall varchar(10), s_melle varchar(10))"); 
