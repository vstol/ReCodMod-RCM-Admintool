...
echo "<center><th><b><a href='top.php'>" . colorize($servername) . "</a></b>  
<b><a href='top.php'>" . colorize($color . "TOP $nombre_messages PLAYERS") . "</a></b></th></center>"; ?></table>		
		<table>
                <tbody><tr>
<th><b>#</b><SPAN class="tooltipxo">PLACE </SPAN></th>
				<th><b>Name / Guid</b></th>
				
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_kills">Kills<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Kills</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_deaths">Deaths<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Deaths</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_ratio">K/D<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> K/D</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_skill">Skill<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Skill</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_heads">Heads<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> HeadShots</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_grenade">Grenades<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Grenades</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_melle">Knife<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Mellee</SPAN></a> </b></th>
				<th><b><a href="top.php?server=<?php echo $server_id ?>&style=s_suicids">Suicides<SPAN class="tooltipxo">TOP <?php echo $number_msg_at_page?> Suicides</SPAN></a> </b></th>
...
$pagger = '';
    ...
    echo '  [<a href="top.php?'.$pagger.'server='.$server_id.'&page=' . $z . '"><b><font color="white">' . $z . '</font></b></a>] ';
}}else{echo '</br>';}
?>
...
<input type="hidden" name="servridd" value="<?php echo $server_id ?>">
